...
public class PeriscopeLayout extends RelativeLayout {
  ...
  private void init(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    if (attrs != null) {
      ...
      try {
        final int arrId = a.getResourceId(R.styleable.PeriscopeLayout_plDrawables, 0);
        if (arrId != 0) {
  ...
  private ValueAnimator getBezierValueAnimator(View target) {
    ...
    ValueAnimator animator =
        ValueAnimator.ofObject(evaluator, new PointF((mWidth - dWidth) / 2, mHeight - dHeight),
  ...
  private static class AnimEndListener extends AnimatorListenerAdapter {
    private View target;
  ...
  public static class BezierEvaluator implements TypeEvaluator<PointF> {
    ...
    @Override public PointF evaluate(float time, PointF startValue, PointF endValue) {
